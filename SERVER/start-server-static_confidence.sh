...
QE_MODELS=$matecatdir/QE_data/MateCatData/lang_resources/En-It-IT-D0
...
sentenceconfidence_options="$sentenceconfidence_options $sentenceconfidence_configdir/config_en-it_it_D0.properties"
